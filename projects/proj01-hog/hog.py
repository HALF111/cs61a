...
def swine_align(player_score, opponent_score):
    ...
    if player_score <= 0 or opponent_score <= 0:
        return False
    for i in range(min(player_score, opponent_score), 1, -1):
        if i < 10:
            return False
        elif player_score % i == 0 and opponent_score % i == 0:
            return True
    # END PROBLEM 4a
